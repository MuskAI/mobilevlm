...
API_URL = os.getenv("OPENAI_API_URL", "https://api.deepseek.com/v1")
API_KEY = os.getenv("OPENAI_API_KEY", "sk-5feff6de0c5c41148c7291788fb5bb7f")
GPT_EVAL_MODEL_NAME = "deepseek-chat"
...
def get_chat_response(prompt, model=GPT_EVAL_MODEL_NAME, temperature=0.0, max_tokens=128, patience=3, sleep_time=5):
    ...
    while patience > 0:
        ...
        try:
            ...
            print(f"Retrying...Patience left: {patience}")
