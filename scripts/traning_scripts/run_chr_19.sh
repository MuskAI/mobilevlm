...
case ${TASK} in
    "pretrain-finetune-test")
        ...
        LANGUAGE_MODEL=$3
        VISION_MODEL=$4
        bash run_chr_19.sh ${ARCH} pretrain ${LANGUAGE_MODEL} ${VISION_MODEL} ${OUTPUT_DIR}
        bash run_chr_19.sh ${ARCH} finetune ${LANGUAGE_MODEL} ${VISION_MODEL} ${OUTPUT_DIR}
        bash run_chr_19.sh ${ARCH} test ${OUTPUT_DIR}/mobilevlm-2.finetune
    ;;
    "pretrain-finetune")
        cd ${WORK_DIR}
    ...
    "pretrain")
        ...
        VISION_MODEL=$4
        OUTPUT_DIR=$5
        OUTPUT_DIR_PT=${OUTPUT_DIR}/mobilevlm-linear-19.pretrain
    ...
    "finetune")
        ...
        OUTPUT_DIR=$5
        OUTPUT_DIR_PT=${OUTPUT_DIR}/mobilevlm-linear-19.pretrain
        OUTPUT_DIR_FT=${OUTPUT_DIR}/mobilevlm-linear-19.finetune
